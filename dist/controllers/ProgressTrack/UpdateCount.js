...
const updateCountOfCompletedDays = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { type, id } = req.params;
        if (type === 'predefined') {
            yield predefinedWorkout_1.default.findByIdAndUpdate(id, { $inc: { completedDays: 1 } });
        }
        else if (type === 'custom') {
            yield customWorkout_1.default.findByIdAndUpdate(id, { $inc: { completedDays: 1 } });
        }
        else {
...
exports.default = updateCountOfCompletedDays;
