...
const addCustomWorkout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user;
        const { targetDays, duration, title, startDate } = req.body;
        const endDate = new Date(startDate);
        endDate.setDate(endDate.getDate() + parseInt(targetDays));
        const newCustomWorkout = yield customWorkout_1.default.create({
...
exports.default = addCustomWorkout;
