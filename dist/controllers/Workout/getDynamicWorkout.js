...
const getDynamicWorkout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // const id = req.params.id;
    try {
        const workout = yield workoutModel_1.default.findById(req.params.id);
        if (workout) {
...
exports.default = getDynamicWorkout;
